...
class StockMoveLine(models.Model):
    ...
    def _compute_vlm_pending_quantity(self):
        ...
        for line in self.filtered("has_vlm_operation"):
            line.vlm_pending_quantity = line.quantity
    ...
    def _prepare_vlm_put_task(self, key):
        ...
        quantity_fulfilled = sum(self.mapped("quantity"))
    ...
    def _prepare_vlm_get_tasks(self, key):
        ...
        # This is our demand for this product we'll try to fulfill it in one shot.
        # Anyway we could use other trays if one gets full
        pending_quantity = sum(self.mapped("quantity"))
        tasks = []
    ...
    def _action_done(self):
        ...
        put_in_vlm = sml.filtered(lambda x: x.quantity and x.location_dest_id.is_vlm)
        ...
        get_from_vlm = sml.filtered(lambda x: x.quantity and x.location_id.is_vlm)
